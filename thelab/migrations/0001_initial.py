# Generated by Django 5.0.1 on 2025-01-04 15:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('profile_creation', 'profile_creation'), ('coach_approval', 'coach_approval'), ('event_suggestion', 'event_suggestion')], default='profile_creation', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roster', models.TextField(help_text='(Ideally, a copy-and-pasted link to the roster of the team on which you are or were a player or a coach)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('control_type', models.CharField(choices=[('personal', 'personal'), ('parent', 'parent'), ('business', 'business'), ('boss', 'boss')], default='personal', max_length=15)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='thelab.profile')),
